...
const Client = () => {
    return (
        <div className='px-8 py-10 bg-[#E8E4D8]'>
            ...
            <div className="grid lg:grid-cols-3 grid-cols-1 gap-5 py-6 lg:px-32">
                <div className="card-actions justify-center items-center">
                    <div className="radial-progress bg-black text-black border-4" ></div>
                    <p className="font-medium">Quick service & very trustworthy.</p>
                ...
                <div className="card-actions justify-center items-center">
                    <div className="radial-progress bg-black text-black border-4" ></div>
                    <p className="font-medium">keep things friendly and courteous.</p>
                    <div className="rating">
                        <input type="radio" name="rating-2" className="mask mask-star-2 bg-orange-400" />
                        <input type="radio" name="rating-2" className="mask mask-star-2 bg-orange-400" />
                        <input type="radio" name="rating-2" className="mask mask-star-2 bg-orange-400" />
